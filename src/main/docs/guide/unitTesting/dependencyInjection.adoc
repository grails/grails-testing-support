...
----
include::{sourcedir}/apps/demo33/grails-app/services/demo/ReportingService.groovy[tags=basic_declaration,indent=0]
----

[source,groovy]
.src/main/groovy/demo/MathHelper.groovy
----
include::{sourcedir}/apps/demo33/src/main/groovy/demo/MathHelper.groovy[tags=basic_declaration,indent=0]
----

[source,groovy]
.src/test/groovy/demo/ReportingServiceSpec.groovy
----
include::{sourcedir}/apps/demo33/src/test/groovy/demo/ReportingServiceSpec.groovy[tags=basic_declaration,indent=0]
----