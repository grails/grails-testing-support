...
----
include::{sourcedir}/apps/demo/src/test/groovy/demo/DemoControllerSpec.groovy[tags=basic_declaration,indent=0]
----
...
----
include::{sourcedir}/apps/demo/grails-app/controllers/demo/DemoController.groovy[tags=basic_declaration;render_hello,indent=0]
----

[source,groovy]
.src/test/groovy/demo/DemoControllerSpec.groovy
----
include::{sourcedir}/apps/demo/src/test/groovy/demo/DemoControllerSpec.groovy[tags=basic_declaration;test_render,indent=0]
----
