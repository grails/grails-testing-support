...
----
include::{sourcedir}/apps/demo/grails-app/domain/demo/Person.groovy[indent=0]
----

[source,groovy]
.src/test/groovy/demo/PersonSpec.groovy
----
include::{sourcedir}/apps/demo/src/test/groovy/demo/PersonSpec.groovy[indent=0]
----
...
----
include::{sourcedir}/apps/demo/src/test/groovy/demo/DataTestTraitSpec.groovy[indent=0]
----
...
----
include::{sourcedir}/apps/demo/src/test/groovy/demo/GetDomainClassesToMockMethodSpec.groovy[indent=0]
----
...
----
include::{sourcedir}/apps/demo/src/test/groovy/demo/PersonControllerSpec.groovy[indent=0]
----
