...
[source,groovy]
----
include::{sourcedir}/apps/demo33/grails-app/controllers/demo/UrlMappings.groovy[indent=0]
----
...
[source,groovy]
----
include::{sourcedir}/apps/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=setup,indent=0]
----
...
[source,groovy]
----
include::{sourcedir}/apps/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=forward,indent=0]
----
...
[source,groovy]
----
include::{sourcedir}/apps/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=reverse,indent=0]
----
...
[source,groovy]
----
include::{sourcedir}/apps/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=combined,indent=0]
----
...
[source,groovy]
----
include::{sourcedir}/apps/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=controller,indent=0]
----
...
[source,groovy]
----
include::{sourcedir}/apps/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=action,indent=0]
----
...
[source,groovy]
----
include::{sourcedir}/apps/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=view,indent=0]
----
