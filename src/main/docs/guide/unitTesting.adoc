...
[source,groovy]
----
include::{sourcedir}/apps/demo33/src/test/groovy/demo/DefineBeansSpec.groovy[tags=test_declaration,indent=0]
----
...
[source,groovy]
----
include::{sourcedir}/apps/demo33/src/test/groovy/demo/AutowiredTestSpec.groovy[tags=test_declaration,indent=0]
----
